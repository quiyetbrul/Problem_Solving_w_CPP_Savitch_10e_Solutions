...
void get_input_ftin_mcm(double& feet, double& inches){
...
void get_output_ftin_mcm(double& feet, double&inches){
    get_input_ftin_mcm(feet,inches);
...
void Ch5_Practice_Program_2(){
    ...
    get_output_ftin_mcm(feet, inches);
}